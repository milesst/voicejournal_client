...
export default function ScheduleWeekClass(props) {
    ...
    return (
        <div className={"ScheduleWeekClass" + (open ? '' : ' class-hidden') + (props.index >= props.selected ? ' right' : ' left')} style={{'z-index': props.index, 'max-width': (100 - props.index*15) + '%', 'minWidth': (100 - props.index*20)/props.index+1}} onClick={props.selectClass}>
